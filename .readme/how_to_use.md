...
3. **Drag & Drop**: Конвертер сжимает или распаковывает файлы перенесённые на исполняемый файл.
...
3. Используйте утилиту напрямую из папки или используя Drag & Drop.
...
### Drag & Drop.
1. Перетащите один или несколько файлов на `dvpl.exe`.
